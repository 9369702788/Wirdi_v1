...
/// Screen 4 — Home Dashboard: greeting, daily progress, next prayer
/// countdown, continue reading, dhikr of the day.
class HomeDashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('وردي')),
      body: ListView(
        ...
        children: [
          ...
          const Text('واصل ما بدأته اليوم', style: TextStyle(color: AppColors.mutedText)),
          const SizedBox(height: 20),

          // PremiumHeroCard — Next prayer countdown
          Container(
            ...
            child: const Column(
              ...
              children: [
                Text('الصلاة القادمة', style: TextStyle(color: Colors.white70)),
                SizedBox(height: 8),
                Text('العصر',
                    style: TextStyle(
                        color: Colors.white,
          ...
          // WirdProgressRing card
          _DashboardCard(
            icon: Icons.donut_large,
            title: 'الورد اليومي',
            subtitle: '3 من 5 صفحات — استمر 🔥',
            trailing: const _MiniProgress(value: 0.6),
          ),
